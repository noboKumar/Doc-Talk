...
const BookingCard = ({ booking }) => {
  const { name, consultant_fees, education, speciality } = booking;
  return (
    <div className="space-y-3 bg-white p-8 rounded-2xl">
      ...
      <button className="btn text-[#FF0000] border-[#FF0000] text-xl border-2 rounded-4xl w-full py-5 hover:bg-[#FF0000] hover:text-white cursor-pointer">
        Cancel Appointment
      </button>
    </div>
  );
